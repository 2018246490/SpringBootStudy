...
public class StringUtil {
	...
	/**
	 * 验证码生成方法，此方法存在重复的概率，以后完善。
	 * */
	public static String getCode(){
		return String.valueOf((long)((Math.random()*9+1)* 100000));
	}
	/**
	 * 检查浮点数
	 * 
	 ...
	 * @return
	 */
	public static boolean regMatch(String str){
	...
	public static String getDateString (Date da){
		SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		if(null != da)
			return sf.format(da).toString();
		else
			return null;
	}
